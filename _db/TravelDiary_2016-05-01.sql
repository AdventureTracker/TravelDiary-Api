...
# Generation Time: 2016-05-01 20:36:50 +0000
# ************************************************************
...
VALUES
	(1,1,'5d6186fc-a852-456b-b2ed-bbf7668b60a5','2016-05-01 21:26:15','2016-03-28 21:03:11','2016-05-01 21:26:15'),
	(4,5,'f49061d5-6b8e-418b-8666-788585dd1a78','2016-04-21 14:32:42','2016-04-19 11:29:42','2016-04-21 14:32:42');
...
CREATE TABLE `device` (
  ...
  `dev_name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dev_type` enum('WEB','PHONE') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'PHONE',
  `dev_version` text COLLATE utf8_unicode_ci,
  `dev_os` text COLLATE utf8_unicode_ci,
  `dev_lastActivity` timestamp NULL DEFAULT NULL,
  `dev_createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `dev_updatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `device` (`id_device`, `id_user`, `dev_uuid`, `dev_name`, `dev_type`, `dev_version`, `dev_os`, `dev_lastActivity`, `dev_createdAt`, `dev_updatedAt`)
VALUES
	(1,1,'669ea7a7-b600-4ed9-b85e-13aabd222775','PhpStorm','PHONE',NULL,NULL,NULL,'2016-03-18 01:12:25','2016-05-01 21:27:35'),
	(5,2,'81bf8b12-0d38-4e4c-80bb-df5f767a04a1',NULL,'PHONE',NULL,NULL,NULL,'2016-04-19 11:29:42','2016-04-19 11:29:42');
...
CREATE TABLE `photo` (
  ...
  `pht_filename` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pht_mime` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
...
VALUES
	(8,2,1,'b429b294-ac24-423f-bb5a-a90998dd7612','Norway 2015','Trolltunga, Odda, Norway','A low-cost hitchhiking trip through the Scandinavia and the Baltic states.','2015-07-12','2015-08-04','2016-03-29 21:54:03','2016-04-19 01:21:03'),
	(11,1,1,'7e03cb57-a89d-4b6d-9bff-f908623aa1fc','Island 2016','Island','A low-cost backpacking trip through Island.','2016-07-05','2015-08-12','2016-05-01 21:18:15','2016-05-01 21:18:15');
...
CREATE TABLE `user` (
  ...
  `usr_uuid` varchar(128) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  UNIQUE KEY `UNIQUE_usr_UUID` (`usr_uuid`),
...
INSERT INTO `user` (`id_user`, `id_role`, `usr_uuid`, `usr_firstName`, `usr_lastName`, `usr_email`, `usr_password`, `usr_lastSeen`, `usr_createdAt`, `usr_updatedAt`)
VALUES
	(1,1,'6205fea4-0380-4a19-802b-2217cc2949ff','Jakub','Dubec','jakub.dubec@gmail.com','$2y$13$jugbchb1Jxk3/tk92ui.2OioNoicE4XxH4KO.LxcVDXl3kJ55DUUC','2016-04-21 15:17:29','2016-03-18 01:12:03','2016-03-18 01:12:08'),
	(2,1,'5ee2ba78-5891-4138-a358-619017f9efe9','Milan','Hurta','admin@jakubdubec.me','$2y$13$jugbchb1Jxk3/tk92ui.2OioNoicE4XxH4KO.LxcVDXl3kJ55DUUC',NULL,'2016-04-19 10:24:15',NULL);
